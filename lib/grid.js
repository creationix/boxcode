...
define("grid", function () {
  ...
  Leaf.prototype.split = function (orientation) {
    this.grid.innerSplit(orientation);
  };

  Leaf.prototype.menu = [
    {action: "split", param: "bottom", name: "Vertical Split", description: "Split the panel in half vertically", shortcut: {ctrlKey: true, shiftKey: true, keyCode: 72}},
    {action: "split", param: "right", name: "Horizontal Split", description: "Split the panel in half horizontally", shortcut: {ctrlKey: true, shiftKey: true, keyCode: 66}},
    {action: "collapse", name: "Collapse", description: "Unsplit", shortcut: {ctrlKey: true, shiftKey: true, keyCode: 87}},
  ];
