...
define("grid", function () {
  ...
  Leaf.prototype.menu = [
    {action: "split", param: "bottom", name: "Vertical Split", description: "Split the panel in half vertically"},
    {action: "split", param: "right", name: "Horizontal Split", description: "Split the panel in half horizontally"},
